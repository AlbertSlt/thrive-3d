const Nosotros = () => {
    return (
        <div>
            <h1 style={{ textAlign: "center", marginTop: "2.5rem" }}>Sobre nosotros</h1>
            <div
                style={{
                    display: 'flex',
                ...
                <p style={{ textAlign: 'center', fontSize: '1.3rem' }}>Somos tu socio confiable en el mundo de la impresión 3D. Con más de 3 años de experiencia en el mercado, nos dedicamos a ofrecerte una amplia gama de insumos de alta calidad para tus proyectos.
                    ...
                    Nuestro compromiso es impulsar tu creatividad, brindándote los recursos necesarios para que cada una de tus ideas tome forma y se convierta en una realidad palpable. Explora con nosotros las infinitas posibilidades que la impresión 3D tiene para ofrecerte y lleva tus creaciones al siguiente nivel.</p>
            </div>
